...
public class SqlServerDailyValueIncrementer extends AbstractColumnMaxValueIncrementer {

	/*** The SQL string for retrieving the new sequence value */
	private static final String VALUE_SQL = "select @@identity";
	 ...
	 * @see #setColumnName
	 */
	public SqlServerDailyValueIncrementer() {
	}
	 ...
	 */
	public SqlServerDailyValueIncrementer(DataSource dataSource, String incrementerName, String columnName) {
