package com.ddim.happygo.web.admin.longads;
 ...
 * */
@Component
public class LongAdsFormValidator {
	 ...
	 * @throws Exception
	 */
	public void validate(LongAdsForm form, BindingResult result, String uploadFilePath) throws Exception {
