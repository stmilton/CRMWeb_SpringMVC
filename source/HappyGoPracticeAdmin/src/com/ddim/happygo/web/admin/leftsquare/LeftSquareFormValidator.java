 ...
 * */
@Component
public class LeftSquareFormValidator {
	 ...
	 * @throws Exception
	 */
	public void validate(LeftSquareForm form, BindingResult result, String uploadFilePath) throws Exception {
		...
		if (StringUtils.isBlank(form.getAd_proposal())) {
			...
			result.rejectValue("ad_proposal", "error", "限150字");
		}
	}
