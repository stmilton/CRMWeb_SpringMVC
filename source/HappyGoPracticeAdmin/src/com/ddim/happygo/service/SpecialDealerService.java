 ...
 */
@Service
public class SpecialDealerService {
	...
	public Page<SpecialDealer> findPage(String specialDealerClass, String name, String status, PagingParameter paging)
			throws Exception {
		return specialDealerDao.findPage(specialDealerClass, name, status, paging);
	}
	...
	public int countList() throws Exception {
		return specialDealerDao.countList();
	}
	...
	public SpecialDealer get(String id) throws Exception {
		return specialDealerDao.get(id);
	}
	...
	public void save(SpecialDealer entity, String modifier) throws Exception {
		...
		if (StringUtils.isBlank(entity.getId())) {
			...
			int dataNums = specialDealerDao.countList();
			entity.setSort(dataNums + 1);
			specialDealerDao.insert(entity);
		} else {
			entity.setModifier(modifier);
			entity.setModify_time(now);
			specialDealerDao.update(entity);
		}
	}
	...
	public void delete(String[] ids, String modifier) throws Exception {
		for (String id : ids) {
			SpecialDealer entity = get(id);
			specialDealerDao.delete(entity.getSort(), entity.getId());
		}
	}
	...
	public void updateStatus(String[] ids, String status, String modifier) throws Exception {
		for (String id : ids) {
			SpecialDealer entity = get(id);
			specialDealerDao.updateStatus(entity.getId(), status, modifier);
		}
	}
	...
	public void updateSort(String id, int sort, String modifier) throws Exception {
		SpecialDealer entity = get(id);
		specialDealerDao.updateSort(id, entity.getSort(), sort, modifier);
	}
