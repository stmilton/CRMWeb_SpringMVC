 ...
 */
@Repository
public class LeftSquareDao {

	@Autowired
	private SimpleJdbc simpleJdbc;
	public final static String TABLE_NAME = "HG_LEFT_SQUARE";
	...
	public Page<LeftSquare> findPage(String name, String status, PagingParameter paging) throws Exception {
		...
		return simpleJdbc.findPage(sb.toString(), args.toArray(), paging, ClassRowMapperFactory.get(LeftSquare.class));
	}
	...
	public LeftSquare get(String id) throws Exception {
		...
		sb.append(" WHERE ID=?");
		Object[] args = { id };
		return simpleJdbc.getFirst(simpleJdbc.query(sb.toString(), args, ClassRowMapperFactory.get(LeftSquare.class)));
	}
	 ...
	 * @throws Exception
	 */
	public void insert(LeftSquare entity) throws Exception {
	 ...
	 * @throws Exception
	 */
	public void update(LeftSquare entity) throws Exception {
	...
	public void updateSort(String id, int initSort, int sort, String modifier) throws Exception {
		Timestamp now = new Timestamp(new GregorianCalendar().getTimeInMillis());
		LeftSquare temp = this.getBySort(sort);
	 ...
	 * @throws Exception
	 */
	public LeftSquare getBySort(int sort) throws Exception {
		StringBuffer sb = new StringBuffer("SELECT * FROM ");
		sb.append(TABLE_NAME);
