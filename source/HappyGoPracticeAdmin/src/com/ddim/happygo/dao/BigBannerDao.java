...
public class BigBannerDao {
	...
	public final static String TABLE_NAME = "HG_BIG_BANNER";
	...
	public Page<BigBanner> findPage(String name, String status, PagingParameter paging) throws Exception {
		...
		return simpleJdbc.findPage(sb.toString(), args.toArray(), paging, ClassRowMapperFactory.get(BigBanner.class));
	}
	...
	public BigBanner get(String id) throws Exception {
		...
		sb.append(" WHERE ID=?");
		Object[] args = { id };
		return simpleJdbc.getFirst(simpleJdbc.query(sb.toString(), args, ClassRowMapperFactory.get(BigBanner.class)));
	}
	 ...
	 * @throws Exception
	 */
	public void insert(BigBanner entity) throws Exception {
	 ...
	 * @throws Exception
	 */
	public void update(BigBanner entity) throws Exception {
	...
	public void updateSort(String id, int initSort, int sort, String modifier) throws Exception {
		Timestamp now = new Timestamp(new GregorianCalendar().getTimeInMillis());
		BigBanner temp = this.getBySort(sort);
	 ...
	 * @throws Exception
	 */
	public BigBanner getBySort(int sort) throws Exception {
		StringBuffer sb = new StringBuffer("SELECT * FROM ");
		sb.append(TABLE_NAME);
