 ...
 */
@Repository
public class RightSquareDao {

	@Autowired
	private SimpleJdbc simpleJdbc;
	public final static String TABLE_NAME = "HG_RIGHT_SQUARE";
	...
	public Page<RightSquare> findPage(String name, String status, PagingParameter paging) throws Exception {
		...
		return simpleJdbc.findPage(sb.toString(), args.toArray(), paging, ClassRowMapperFactory.get(RightSquare.class));
	}
	...
	public RightSquare get(String id) throws Exception {
		...
		sb.append(" WHERE ID=?");
		Object[] args = { id };
		return simpleJdbc.getFirst(simpleJdbc.query(sb.toString(), args, ClassRowMapperFactory.get(RightSquare.class)));
	}
	 ...
	 * @throws Exception
	 */
	public void insert(RightSquare entity) throws Exception {
	 ...
	 * @throws Exception
	 */
	public void update(RightSquare entity) throws Exception {
	...
	public void updateSort(String id, int initSort, int sort, String modifier) throws Exception {
		Timestamp now = new Timestamp(new GregorianCalendar().getTimeInMillis());
		RightSquare temp = this.getBySort(sort);
	 ...
	 * @throws Exception
	 */
	public RightSquare getBySort(int sort) throws Exception {
		StringBuffer sb = new StringBuffer("SELECT * FROM ");
		sb.append(TABLE_NAME);
