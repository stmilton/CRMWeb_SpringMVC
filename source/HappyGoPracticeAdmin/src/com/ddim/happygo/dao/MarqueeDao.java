...
public class MarqueeDao {
	 ...
	 * @throws Exception
	 */
	public Page<Marquee> findPage(String name, String status, PagingParameter paging) throws Exception {
		...
		return simpleJdbc.findPage(sb.toString(), args.toArray(), paging, ClassRowMapperFactory.get(Marquee.class));
	}
	 ...
	 * @throws Exception
	 */
	public Marquee get(String id) throws Exception {
		StringBuffer sb = new StringBuffer("SELECT * FROM ");
		sb.append(TABLE_NAME);
		sb.append(" WHERE ID=?");
		Object[] args = { id };
		return simpleJdbc.getFirst(simpleJdbc.query(sb.toString(), args, ClassRowMapperFactory.get(Marquee.class)));
	}
	 ...
	 * @throws Exception
	 */
	public void insert(Marquee entity) throws Exception {
	 ...
	 * @throws Exception
	 */
	public void update(Marquee entity) throws Exception {
		String sql = "UPDATE " + TABLE_NAME
				+ " SET NAME=?, START_TIME=?, END_TIME=?, STATUS=?, LINK=?, OPEN_METHOD=?, MODIFIER=?, MODIFY_TIME=? WHERE ID=?";
		Object[] args = { entity.getName(), entity.getStart_time(), entity.getEnd_time(), entity.getStatus(),
				entity.getLink(), entity.getOpen_method(), entity.getModifier(), entity.getModify_time(),
				entity.getId() };
	...
	public void updateSort(String id, int initSort, int sort, String modifier) throws Exception {
		Timestamp now = new Timestamp(new GregorianCalendar().getTimeInMillis());
		Marquee temp = this.getBySort(sort);
	 ...
	 * @throws Exception
	 */
	public Marquee getBySort(int sort) throws Exception {
		StringBuffer sb = new StringBuffer("SELECT * FROM ");
		sb.append(TABLE_NAME);
