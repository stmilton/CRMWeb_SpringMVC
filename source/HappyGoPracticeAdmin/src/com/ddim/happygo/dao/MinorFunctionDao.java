...
public class MinorFunctionDao {
	...
	public MinorFunction get(String id) throws Exception {
		...
		Object[] args = { id };
		return simpleJdbc
				.getFirst(simpleJdbc.query(sb.toString(), args, ClassRowMapperFactory.get(MinorFunction.class)));
	}
	 ...
	 * @throws Exception
	 */
	public void insert(MinorFunction entity) throws Exception {
	 ...
	 * @throws Exception
	 */
	public void update(MinorFunction entity) throws Exception {
		String sql = "UPDATE " + TABLE_NAME
				+ " SET NAME=?, MAJOR_NAME=?, STATUS=?, LINK=?, OPEN_METHOD=?, MODIFIER=?, MODIFY_TIME=? WHERE ID=?";
		Object[] args = { entity.getName(), entity.getMajor_name(), entity.getStatus(), entity.getLink(),
				entity.getOpen_method(), entity.getModifier(), entity.getModify_time(),
				entity.getId() };
	...
	public void updateSort(String id, int initSort, int sort, String modifier) throws Exception {
		Timestamp now = new Timestamp(new GregorianCalendar().getTimeInMillis());
		MinorFunction temp = this.getBySort(sort);
	 ...
	 * @throws Exception
	 */
	public MinorFunction getBySort(int sort) throws Exception {
		StringBuffer sb = new StringBuffer("SELECT * FROM ");
		sb.append(TABLE_NAME);
		sb.append(" WHERE SORT=?");
		Object[] args = { sort };
		return simpleJdbc.getFirst(simpleJdbc.query(sb.toString(), args, ClassRowMapperFactory.get(MinorFunction.class)));
	}
