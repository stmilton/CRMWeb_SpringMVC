...
public class FooterDao {
	...
	public Page<Footer> findPage(String name, String status, PagingParameter paging) throws Exception {
		...
		return simpleJdbc.findPage(sb.toString(), args.toArray(), paging, ClassRowMapperFactory.get(Footer.class));
	}
	...
	public Footer get(String id) throws Exception {
		...
		sb.append(" WHERE ID=?");
		Object[] args = { id };
		return simpleJdbc.getFirst(simpleJdbc.query(sb.toString(), args, ClassRowMapperFactory.get(Footer.class)));
	}
	 ...
	 * @throws Exception
	 */
	public void insert(Footer entity) throws Exception {
	 ...
	 * @throws Exception
	 */
	public void update(Footer entity) throws Exception {
	...
	public void updateSort(String id, int initSort, int sort, String modifier) throws Exception {
		Timestamp now = new Timestamp(new GregorianCalendar().getTimeInMillis());
		Footer temp = this.getBySort(sort);
	 ...
	 * @throws Exception
	 */
	public Footer getBySort(int sort) throws Exception {
		StringBuffer sb = new StringBuffer("SELECT * FROM ");
		sb.append(TABLE_NAME);
